...
const CreateProposal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const proposal = { title, description, candidateNames, maxTokensPerAddress: tokensPerAddress, qvEnabled, linearTimeDecayEnabled: timeDecayEnabled }
...
export default CreateProposal
          ...
          //     type="number"
          //     name="Max tokens per address"
          //     placeholder="Max number of voting tokens per address"
